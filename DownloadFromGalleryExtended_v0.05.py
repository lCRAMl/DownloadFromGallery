...
-------------------------------------------------------------------------------
"""
URL = 'https://emma-stone.com/photos/thumbnails.php?album=994'
#dest = 'C:\\Users\\silence\\Desktop\\ja\\2014\\Jessica Alba - Spike TVs Guys Choice 2014 at Sony Pictures Studios 2014-06-07\\'
dest = 'C:\\Users\\silence\\Desktop\\Emma Stone Test\\'
picprefix = ''
...
async def main():
    ...
    tasks = [loop.create_task(download(file, dest, picprefix)) for file in filelist]
...
if website.status_code == 200:
    ...
    print("ERROR: bad answer from Website")
